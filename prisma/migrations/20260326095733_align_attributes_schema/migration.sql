/*
  ...
  - You are about to drop the column `requiresCooking` on the `Product` table. All the data in the column will be lost.
  - Added the required column `cookingState` to the `Product` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Product" ("caloriesPer100g", "carbsPer100g", "category", "createdAt", "fatPer100g", "id", "ingredientsComposition", "isGlutenFree", "isSugarFree", "isVegan", "name", "proteinPer100g", "updatedAt") SELECT "caloriesPer100g", "carbsPer100g", "category", "createdAt", "fatPer100g", "id", "ingredientsComposition", "isGlutenFree", "isSugarFree", "isVegan", "name", "proteinPer100g", "updatedAt" FROM "Product";
DROP TABLE "Product";
